    ...
    <div className="max-w-3xl mx-auto mt-10 px-6 py-8 bg-white rounded-2xl shadow-lg">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="grid gap-4 grid-cols-2" >
        ...
        <div>
          ...
          {/* Publisher */}
        <div>
          <label className="block text-gray-700 font-medium mb-1">Publisher Name</label>
          <input
            type="text"
            {...register('publisher')}
            className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
        ...
        {/* Published Year */}
        <div>
          <label className="block text-gray-700 font-medium mb-1">Published Year</label>
          <input
            type="number"
        ...
        <div>
          ...
          />
          {errors.total_copies && <p className="text-red-500 text-sm mt-1">{errors.total_copies.message}</p>}
        </div>

        {/* Book Image */}
        <div>
          <label className="block text-gray-700 font-medium mb-1">Book Image URL</label>
          <input
            {...register('book_img')}
            className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
