...
toast.error('❌ This book is already borrowed!');
  ...
  <div>
      ...
      <div className="px-4 py-4">
        ...
        <p className="text-gray-700 text-sm">Published: {book.published_year}</p>
        <p className="text-gray-700 text-sm">Available: {book.available_copies}</p>
      </div>
      <button onClick={handelBorrowed} className="my-2 mx-auto flex justify-center  bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">
          Borrow
        </button>
    </div>
     {showModal && (
          ...
          <div className="bg-white p-6 rounded-xl w-96">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div>
                ...
                />
                {errors.borrow_date && <p className="text-red-500 text-sm">Borrow date is required</p>}
              </div>
